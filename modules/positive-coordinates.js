...
var messages = /* I18N_START */ {
    ...
    "fr": {
        ...
        "movePrompt": "Déplacez ★ vers :<br>($1, $2)",
        "pointLabel": "Point :",
  ...
  function initInstance( host ) {
    ...
    function nextChallenge() {
      ...
      promptBar.innerHTML = t('movePrompt', [
        '<span class="cex-target-x">' + targetX + '</span>', 
        '<span class="cex-target-y">' + targetY + '</span>' 
      ]);
      draw();
    }
