...
// Find all radian modules
  document.querySelectorAll('.hiruwiki[data-module="radian"]').forEach(function(container) {
    ...
    for(let d=0; d<=360; d+=5){
      ...
      if(d%30===0){len=12; cls="tickMajor";}
      else if(d%10===0){len=8; cls="tickMedium";}
      const p1 = polar(a,R);
    ...
    function update(){
      ...
      const t2 = create("tspan"); t2.setAttribute("x",lp.x); t2.setAttribute("dy",16); t2.textContent=piText;
